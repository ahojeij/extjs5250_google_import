...
final class Tn5250ScreenData  implements TN5250jConstants {
    ...
    final private List<Tn5250ScreenElement> screenElements;
    ...
    public Tn5250ScreenData(int startRow, int startCol, Screen5250 screen) {
        this.screenElements = new Vector<Tn5250ScreenElement>();
	...
	public Tn5250ScreenElement initScreenElement(int lastAttr){
		return initScreenElement(row, lastAttr);
	}
	
	private Tn5250ScreenElement initScreenElement(int row, int lastAttr){
		Tn5250ScreenElement element = new Tn5250ScreenElement();
	...
	public List<Tn5250ScreenElement> getScreenElements() {
	 ...
	 public void updateScreenElements(){
			for(Tn5250ScreenElement element : screenElements){
				element.update();
			}
	}
		...
		static public void readDebug(Tn5250ScreenData screenRect){
		...
		static public void saveDebug(Tn5250ScreenData screenRect){
