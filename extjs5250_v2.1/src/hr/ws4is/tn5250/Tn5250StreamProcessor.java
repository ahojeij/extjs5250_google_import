...
enum Tn5250StreamProcessor {
	 ...
	 */
	static public void refresh(Session5250 session, Tn5250ScreenResponse response){
		List<Tn5250ScreenElement> list = getResponse(session);
	 ...
	 */
	static public boolean process(Session5250 session, Tn5250ScreenRequest request, Tn5250ScreenElement[] fields){
	...
	static private boolean  updateFieldValues(Screen5250 screen, Tn5250ScreenElement[] webFields){
		boolean sendIt = false;
		ScreenFields fields = screen.getScreenFields();
        for(Tn5250ScreenElement webField :  webFields){
	...
	static private List<Tn5250ScreenElement> getResponse(Session5250 session){

		  Screen5250 screen = session.getScreen();
          Tn5250ScreenData screenRect = new Tn5250ScreenData(1, 1, screen);
	...
	static private void processFields(Tn5250ScreenData screenRect, int pos){
	...
	static private void processMultiLineField(Tn5250ScreenData screenRect, ScreenField screenField, int len, int fieldMask){		 
