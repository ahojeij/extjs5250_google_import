...
Ext.extend(Ext.ux.data.DWRProxy, Ext.data.DataProxy, {
	...
	request : function(action, rs, params, reader, callback, scope, options) {
            params = params || {};
            if ((action === Ext.data.Api.actions.read) ? this.fireEvent("beforeload", this, params) :
          ...
          doRequest : function(action, rs, params, reader, cb, scope, opts) {
             this.load(params, reader, cb, scope, opts);
          },
	/**
