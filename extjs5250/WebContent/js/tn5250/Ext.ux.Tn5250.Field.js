...
Ext.ux.Tn5250.Field = Ext.extend(Ext.Component, {

    initComponent : function(){

		Ext.ux.Tn5250.Field.superclass.initComponent.call(this);
        this.addEvents(
                'focus',
                'blur'
                );        
    ...
    onRender : function(ct, position){
        ...
        if(!this.el){
            ...
            Ext.ux.Tn5250.Field.superclass.onRender.call(this, ct, position);
        }
