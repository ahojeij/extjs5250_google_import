...
Ext.ns('Ext.ux.Tn5250');

Ext.ux.Tn5250.ScreenElement = function(config) {
	config = config || {};
	Ext.apply(this, config);

	Ext.ux.Tn5250.ScreenElement.superclass.constructor.call(this);
};

Ext.extend(Ext.ux.Tn5250.ScreenElement, Ext.util.Observable, {
