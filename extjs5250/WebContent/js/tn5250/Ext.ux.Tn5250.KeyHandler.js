...
Ext.ux.Tn5250.KeyHandler = function(config) {
	config = config || {};
	devName : '';
	Ext.apply(this, config);

	Ext.ux.Tn5250.KeyHandler.superclass.constructor.call(this);
	this.initComponent();
};

Ext.extend( Ext.ux.Tn5250.KeyHandler , Ext.util.Observable, {

	initComponent : function(){

          if ( !Ext.ux.Tn5250.keyManager )
              Ext.ux.Tn5250.keyManager = new Ext.ux.Tn5250.KeyManager();

          Ext.ux.Tn5250.keyManager.register( this );
	 ...
	 _kh_activate : function(){
		if (!Ext.ux.Tn5250.keyManager) return;
		 Ext.ux.Tn5250.keyManager.windowActivate(this);
	 },
...
Ext.ux.Tn5250.KeyManager = function( config ) {
    config = config || {};
    Ext.apply( this, config );
    this.bypass=false;
...
Ext.extend( Ext.ux.Tn5250.KeyManager, Ext.util.Observable, {
